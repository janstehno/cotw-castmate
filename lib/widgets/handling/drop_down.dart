...
class WidgetDropDown<V> extends StatelessWidget {
  ...
  Color get _actualBackground => _background ?? Interface.transparent;
  ...
  DropdownButton2 get dropdownButton => DropdownButton2(
        ...
        iconStyleData: IconStyleData(
          ...
          iconEnabledColor: Interface.primaryLight,
          iconDisabledColor: Interface.disabled,
        ),
        dropdownStyleData: DropdownStyleData(
          // maxHeight: 300,
          padding: EdgeInsets.zero,
          decoration: BoxDecoration(color: Interface.primaryAccentDarker),
        ),
